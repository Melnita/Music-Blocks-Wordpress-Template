                ...
                <div class="container">
                    ...
                    <div class="column dt-sc-one-fourth first">
                        <aside class="widget widget_text">
                            <h3 class="widgettitle red_sketch"> About Music Blocks </h3>
                    ...
                    <div class="column dt-sc-one-fourth">
                        <aside class="widget widget_recent_entries">
                            <h3 class="widgettitle green_sketch"> Recent Update </h3>
                            <ul>
                                <li>
                                    <a href="">
                    ...
                    <div class="column dt-sc-one-fourth">
                        <aside class="widget tweetbox">
                            <h3 class="widgettitle yellow_sketch"><a href="#"> Lorem ipsum </a></h3>
                    ...
                    <div class="column dt-sc-one-fourth">
                        ...
                        <h3 class="widgettitle steelblue_sketch">Contact</h3>
                            <div class="textwidget">
                                <p class="dt-sc-contact-info"><span class="fa fa-map-marker"></span> Lorem ipsum dolor sit amet <br> United States </p>
                                <!--<p class="dt-sc-contact-info"><span class="fa fa-phone"></span> (000) xxx - xxxx </p>-->
                                <p class="dt-sc-contact-info"><span class="fa fa-envelope"></span><a href="mailto:yourname@somemail.com"> xyz@musicblocks.net </a></p>
                            </div>
                        </aside>
